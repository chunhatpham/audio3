...
window.realMoviesDatabase = [
    { title: "Mập Mờ Với Con Thầy Giáo", img: "https://i.postimg.cc/3RcFxzy5/C401AC14-4C58-4E6B-936B-273E1C8A0DF7.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Nghi Ngờ Bạn Gái Trọng Sinh", img: "https://i.postimg.cc/zBcFG4y9/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bạn Gái Tôi Xinh Nhất", img: "https://i.postimg.cc/fLrfR1V1/IMG-1499.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Cô Bạn Gái Nói Dối Tôi", img: "https://i.postimg.cc/PfS6rWWq/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
...
window.openPlayer = function(movieName) {
    ...
    let audioLink = "";
    if (movieName.includes('Mập Mờ Với Con Thầy Giáo')) audioLink = "https://videotourl.com/audio/1777829654952-31035f14-1573-4de6-b998-4609f1d0387c.m4a";
    else if (movieName.includes('Nghi Ngờ Bạn Gái Trọng Sinh')) audioLink = "https://videotourl.com/audio/1777829499456-5489afbf-69da-4148-8161-fb5d29d4f17b.m4a";
    else if (movieName.includes('Bạn Gái Tôi Xinh Nhất')) audioLink = "https://videotourl.com/audio/1777829309308-30991d93-2434-4d3c-accf-e5156d6196cf.m4a";
    else if (movieName.includes('Cô Bạn Gái Nói Dối Tô')) audioLink = "https://videotourl.com/audio/1777654118551-776f3635-5618-465a-8b2e-bd379f83997a.m4a";
    else if (movieName.includes('Chuyến Tàu Đầy Định Mệnh')) audioLink = "https://videotourl.com/audio/1777563466161-9f448c73-e9d3-43b0-9f0b-beaddccd6771.m4a";
